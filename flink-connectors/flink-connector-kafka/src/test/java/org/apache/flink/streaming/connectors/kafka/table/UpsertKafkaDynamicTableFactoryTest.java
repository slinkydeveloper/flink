    ...
    public void testBufferedTableSink() {
        ...
        final StreamOperatorFactory<?> sinkOperatorFactory =
                env.getStreamGraph().getStreamNodes().stream()
                        ...
                        .getOperatorFactory();
        assertThat(sinkOperatorFactory).isInstanceOf(SinkOperatorFactory.class);
        assertThat(((SinkOperatorFactory) sinkOperatorFactory).getSink())
                .isInstanceOf(ReducingUpsertSink.class);
    }
