...
public class HiveCatalogTest {
    ...
    public void testRetrieveFlinkProperties() throws Exception {
        ...
        assertThat("jdbc:clickhouse://host:port/testUrl1")
                .isEqualTo(hiveTable.getOptions().get("url"));
        assertThat("jdbc:clickhouse://host:port/testUrl2")
                .isEqualTo(hiveTable.getOptions().get("flink.url"));
    }
    ...
    public void testCreateHiveConf() {
        ...
        assertThat(hiveConf.get("common-key", null)).isNull();
    }
