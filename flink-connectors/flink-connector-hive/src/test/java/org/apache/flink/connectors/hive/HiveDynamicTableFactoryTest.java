...
public class HiveDynamicTableFactoryTest {
    ...
    public void testHiveStreamingSourceOptions() throws Exception {
        ...
        assertThat(configuration.get(STREAMING_SOURCE_PARTITION_ORDER))
                .isEqualTo(PartitionOrder.PARTITION_NAME);
        ...
        assertThat(partitionOrder1).isEqualTo(PartitionOrder.PARTITION_NAME);
        ...
        assertThat(partitionOrder2).isEqualTo(PartitionOrder.PARTITION_TIME);
    }
    ...
    public void testHiveLookupSourceOptions() throws Exception {
        ...
        assertThat(PartitionOrder.PARTITION_NAME)
        ...
        assertThat(PartitionOrder.PARTITION_TIME)
