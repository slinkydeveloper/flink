...
public class HiveRunnerITCase {
    ...
    public void testWriteNullValues() throws Exception {
        ...
        try {
            ...
            assertThat(cols.length).isEqualTo(17);
            assertThat(cols[0]).isEqualTo("NULL");
            assertThat(new HashSet<>(Arrays.asList(cols)).size()).isEqualTo(1);
        } finally {
    ...
    public void testStaticPartition() throws Exception {
        ...
        try {
            ...
            tableEnv.executeSql(
                    ...
                    .await();
            assertThat(hiveCatalog.listPartitions(new ObjectPath("db1", "dest")).size())
                    .isEqualTo(1);
            verifyHiveQueryResult(
