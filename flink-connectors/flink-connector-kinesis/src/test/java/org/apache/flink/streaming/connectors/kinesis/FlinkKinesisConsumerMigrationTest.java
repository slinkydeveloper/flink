...
public class FlinkKinesisConsumerMigrationTest {
    ...
    public void testRestoreWithEmptyState() throws Exception {
        ...
        assertThat(consumerFunction.getRestoredState().isEmpty()).isTrue();
    ...
    public void testRestore() throws Exception {
        ...
        assertThat(consumerFunction.getRestoredState()).isEqualTo(null);
        assertThat(consumerFunction.getRestoredState().size()).isEqualTo(1);
        assertThat(removeEquivalenceWrappers(consumerFunction.getRestoredState()))
                .isEqualTo(TEST_STATE);
        assertThat(fetcher.getSubscribedShardsState().size()).isEqualTo(1);
    ...
    public void testRestoreWithReshardedStream() throws Exception {
        ...
        assertThat(fetcher.getSubscribedShardsState().size()).isEqualTo(3);
