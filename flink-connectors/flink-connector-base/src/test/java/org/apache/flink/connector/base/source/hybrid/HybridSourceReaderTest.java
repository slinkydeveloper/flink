...
public class HybridSourceReaderTest {
    ...
    public void testReader() throws Exception {
        ...
        assertThat(readerContext.getSentEvents()).satisfies(matching(Matchers.emptyIterable()));
        reader.start();
        ...
        assertThat(readerOutput.getEmittedRecords()).satisfies(matching(Matchers.contains(0)));
    ...
    public void testReaderRecovery() throws Exception {
        ...
        assertThat(snapshot).satisfies(matching(Matchers.contains(hybridSplit)));
        ...
        assertThat(reader.snapshotState(1)).satisfies(matching(Matchers.contains(hybridSplit)));
    ...
    private static void assertAndClearSourceReaderFinishedEvent(
        ...
        assertThat(context.getSentEvents()).satisfies(matching(Matchers.iterableWithSize(1)));
