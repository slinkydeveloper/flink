...
public abstract class CatalogTest {
    ...
    public void testAlterTable() throws Exception {
        ...
        assertThat(catalog.getTable(path1)).isEqualTo(table);
        ...
        assertThat(catalog.getTable(path3)).isEqualTo(view);
    ...
    public void testListTables() throws Exception {
        ...
        assertThat(catalog.listTables(db1).size()).isEqualTo(3);
        assertThat(catalog.listViews(db1).size()).isEqualTo(1);
    }
    ...
    public void testDropPartition() throws Exception {
        ...
        assertThat(catalog.listPartitions(path1)).isEqualTo(Collections.emptyList());
    }
    ...
    public void testListPartitionPartialSpec() throws Exception {
        ...
        assertThat(catalog.listPartitions(path1, createPartitionSpecSubset()).size()).isEqualTo(2);
        assertThat(catalog.listPartitions(path1, createAnotherPartitionSpecSubset()).size())
                .isEqualTo(1);
    }
