...
public class TableSchemaTest {
    ...
    public void testTableSchema() {
        ...
        assertThat(schema.getFieldName(5).isPresent()).isFalse();
        assertThat(schema.getFieldType(-1).isPresent()).isFalse();
        assertThat(schema.getFieldType("c").isPresent()).isFalse();
        assertThat(schema.getFieldDataType("f1.q1").isPresent()).isFalse();
        assertThat(schema.getFieldDataType("f1.q3").isPresent()).isFalse();
                ...
                t -> {
                    ...
                    if (t.f1.equals("PASS")) {
                        ...
                        try {
                            ...
                            assertThat(e.getMessage().contains(t.f1)).isTrue();
                        }
                    }
                });
    }
