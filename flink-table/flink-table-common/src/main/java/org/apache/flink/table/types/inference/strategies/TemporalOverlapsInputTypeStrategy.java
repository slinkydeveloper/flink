...
public class TemporalOverlapsInputTypeStrategy implements InputTypeStrategy {
    ...
    public List<Signature> getExpectedSignatures(FunctionDefinition definition) {
        return Collections.singletonList(
                Signature.of(
                        Signature.Argument.of("leftTimePoint", LogicalTypeFamily.DATETIME),
                        Signature.Argument.of("leftTemporal", "<TEMPORAL>"),
                        Signature.Argument.of("rightTimePoint", LogicalTypeFamily.DATETIME),
                        Signature.Argument.of("rightTemporal", "<TEMPORAL>")));
    }
}
