...
public class AtInputTypeStrategy implements InputTypeStrategy {
    ...
    public Optional<List<DataType>> inferInputTypes(
        ...
        if (collection.is(LogicalTypeRoot.ARRAY)) {
            ...
            if (index.isNullable()) {
                return callContext.failInference(
                        throwOnFailure,
                        "The provided index type '%s' is nullable",
                        index);
            }
        ...
        return callContext.failInference(
                throwOnFailure, "Unexpected first argument type '%ss'", collection);
    }
    ...
    public List<Signature> getExpectedSignatures(FunctionDefinition definition) {
        return Arrays.asList(
                Signature.of(
                        Argument.of(LogicalTypeRoot.ARRAY), Argument.of(new IntType(false))),
                Signature.of(Argument.of(LogicalTypeRoot.MAP), Argument.of("<MAP KEY TYPE>")));
    }
}
