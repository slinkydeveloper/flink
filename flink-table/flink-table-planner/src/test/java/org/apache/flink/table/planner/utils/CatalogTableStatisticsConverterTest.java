...
public class CatalogTableStatisticsConverterTest {
    ...
    public void testConvertToColumnStatsMapWithNullColumnStatisticsData() {
        ...
        assertThat(columnStatsMap.size()).isEqualTo(columnStatisticsDataBaseMap.size() - 1);
        assertThat(columnStatsMap.containsKey("first")).isTrue();
        assertThat(columnStatsMap.containsKey("second")).isFalse();
    }
}
