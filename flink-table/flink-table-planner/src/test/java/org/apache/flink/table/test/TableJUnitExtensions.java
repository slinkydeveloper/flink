...
/**
 * The functionalities of this class are exposed by the extension interfaces in this package. Please
 * don't make it public.
 */
class TableJUnitExtensions {
    ...
    static class TableEnvironmentParameterResolver implements ParameterResolver {
        ...
        TableEnvironmentParameterResolver(
                Class<?> defaultInjectedTableEnvironment,
                RuntimeExecutionMode defaultExecutionMode) {
        ...
        public Object resolveParameter(
            ...
            if (paramType.isAssignableFrom(TABLE_ENVIRONMENT_IMPL)) {
                ...
                return extensionContext
                        ...
                        .getOrComputeIfAbsent(
                                ...
                                k ->
                                        org.apache.flink.table.api.bridge.scala
                                                .StreamTableEnvironment.create(
        ...
        private EnvironmentSettings resolveEnvironmentSettings(
            ...
            if (parameterContext.isAnnotated(WithTableEnvironment.class)) {
                executionMode =
                        parameterContext.findAnnotation(WithTableEnvironment.class).get().value();
