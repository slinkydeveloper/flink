...
public class BinaryArrayDataTest {
    ...
    public void testArrayTypes() {
...

        {
            ...
            assertThat(array.isNullAt(0)).isTrue();
            assertThat(25 == array.getFloat(1)).isTrue();
            array.setFloat(0, 5);
            assertThat(5 == array.getFloat(0)).isTrue();
            array.setNullFloat(0);
            assertThat(array.isNullAt(0)).isTrue();

            BinaryArrayData newArray = splitArray(array);
            assertThat(newArray.isNullAt(0)).isTrue();
            assertThat(25 == newArray.getFloat(1)).isTrue();
            newArray.setFloat(0, 5);
            assertThat(5 == newArray.getFloat(0)).isTrue();
...

        {
            ...
            assertThat(array.isNullAt(0)).isTrue();
            assertThat(25 == array.getDouble(1)).isTrue();
            array.setDouble(0, 5);
            assertThat(5 == array.getDouble(0)).isTrue();
            array.setNullDouble(0);
            assertThat(array.isNullAt(0)).isTrue();

            BinaryArrayData newArray = splitArray(array);
            assertThat(newArray.isNullAt(0)).isTrue();
            assertThat(25 == newArray.getDouble(1)).isTrue();
            newArray.setDouble(0, 5);
            assertThat(5 == newArray.getDouble(0)).isTrue();
