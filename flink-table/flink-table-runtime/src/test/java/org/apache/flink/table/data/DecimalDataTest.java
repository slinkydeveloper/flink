...
public class DecimalDataTest {
    ...
    public void testNormal() {
        ...
        assertThat(DecimalData.fromUnscaledBytes(decimal1.toUnscaledBytes(), 5, 0))
                .isEqualTo(decimal1);
        assertThat(decimal1.compareTo(decimal2) < 0).isTrue();
        ...
        assertThat(compare(decimal1, 5) > 0).isTrue();
    ...
    public void testNotCompact() {
        ...
        assertThat(compare(decimal1, 10)).isEqualTo(0);
        assertThat(compare(decimal1, 5) > 0).isTrue();
        assertThat(compare(DecimalData.fromBigDecimal(new BigDecimal("10.5"), 20, 2), 10) > 0)
                .isTrue();
