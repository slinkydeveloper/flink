 ...
 * Upcasting benchmark.
 */
public class UpcastingWithPrimitivesNonNullBenchmark {
    ...
    public static class MyState {
        ...
        public void doSetup() {
            ...
            this.function = CodeGenerationBenchmarkUtils.generateCastFunction(new IntType(false), new BigIntType(false));
        }
