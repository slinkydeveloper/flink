...
public class StateMetaInfoSnapshotEnumConstantsTest {
    ...
    public void testFixedBackendStateTypeEnumConstants() {
        assertThat(StateMetaInfoSnapshot.BackendStateType.values().length).isEqualTo(4);
        assertThat(StateMetaInfoSnapshot.BackendStateType.KEY_VALUE.ordinal()).isEqualTo(0);
        assertThat(StateMetaInfoSnapshot.BackendStateType.OPERATOR.ordinal()).isEqualTo(1);
    ...
    public void testFixedOptionsEnumConstants() {
        assertThat(StateMetaInfoSnapshot.CommonOptionsKeys.values().length).isEqualTo(2);
        assertThat(StateMetaInfoSnapshot.CommonOptionsKeys.KEYED_STATE_TYPE.ordinal()).isEqualTo(0);
        assertThat(
    ...
    public void testFixedSerializerEnumConstants() {
        assertThat(StateMetaInfoSnapshot.CommonSerializerKeys.values().length).isEqualTo(3);
        assertThat(StateMetaInfoSnapshot.CommonSerializerKeys.KEY_SERIALIZER.ordinal())
                .isEqualTo(0);
