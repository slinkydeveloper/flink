...
public class ReporterSetupTest extends TestLogger {
    ...
    public void testSeveralReportersWithArgumentForwarding() {
        ...
        assertThat(reporter2Config.isPresent()).isTrue();
    ...
    public void testMultipleReporterInstantiation() throws Exception {
        ...
        assertThat(reporterSetups.size()).isEqualTo(3);
    ...
    private static void assertReporter1Configured(ReporterSetup setup) {
        ...
        assertThat(setup.getConfiguration().getString("class", null))
    ...
    public void testFactoryPrioritization() throws Exception {
        ...
        assertThat(metricReporter.createdByFactory).isTrue();
    }
    ...
    public void testMixedSetupsFactoryParsing() throws Exception {
        ...
        assertThat(metricReporter1.createdByFactory ^ metricReporter2.createdByFactory).isTrue();
    }
    ...
    public void testAdditionalVariablesParsing() {
        ...
        assertThat(reporterSetup.getAdditionalVariables())
                .satisfies(matching(hasEntry(ScopeFormat.asVariable(tag1), tagValue1)));

        assertThat(reporterSetup.getAdditionalVariables())
                .satisfies(matching(hasEntry(ScopeFormat.asVariable(tag2), tagValue2)));
    }
