...
public class RecreateOnResetOperatorCoordinatorTest {
    ...
    public void testQuiesceableContextNotQuiesced() {
        ...
        assertThat(context.getJobFailureReason()).isSameAs(exception);
    }
    ...
    public void testResetToCheckpoint() throws Exception {
        ...
        assertThat(internalCoordinatorBeforeReset).isNotSameAs(internalCoordinatorAfterReset);
    }
    ...
    public void testMethodCallsOnLongResetToCheckpoint() throws Exception {
        ...
        assertThat(provider.getCreatedCoordinators().size()).isEqualTo(1);
    ...
    public void testConsecutiveResetToCheckpoint() throws Exception {
        ...
        for (TestingOperatorCoordinator internalCoordinator : provider.getCreatedCoordinators()) {
            ...
            assertThat(testingEvent == null || testingEvent.getId() == indexOfCoordinator).isTrue();
            assertThat(
                            failedTasks.isEmpty()
                                    || (failedTasks.size() == 1
