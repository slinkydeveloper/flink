...
public class SerializationProxiesTest {
    ...
    public void testFixTypeOrder() {
        ...
        assertThat(StateDescriptor.Type.values().length).isEqualTo(7);
        // fix the order of elements to keep serialization format stable
        assertThat(StateDescriptor.Type.UNKNOWN.ordinal()).isEqualTo(0);
        assertThat(StateDescriptor.Type.VALUE.ordinal()).isEqualTo(1);
