...
public class PlanGeneratorTest {
    ...
    public void testGenerate() {
        ...
        assertThat(generatedPlanUnderTest.getDataSinks().size()).isEqualTo(1);
        ...
        assertThat(retrievedArtifacts.size()).isEqualTo(originalArtifacts.size());
        assertThat(retrievedArtifacts.get(fileA)).isEqualTo(originalArtifacts.get(fileA));
        assertThat(retrievedArtifacts.get(fileB)).isEqualTo(originalArtifacts.get(fileB));
    }
}
