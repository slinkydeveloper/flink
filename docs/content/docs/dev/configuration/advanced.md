...
These can be removed from the classpath just removing them from the `/lib` folder.
...
you can swap the JARs (copying and pasting them in the downloaded distribution `/lib` folder). 
