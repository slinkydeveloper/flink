    ...
    public void initRecords() throws Exception {
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[0]), // group 0
                                maxParallelism))
                .isEqualTo(0); // group 0
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[1]), // group 1
                                maxParallelism))
                .isEqualTo(1); // group 1
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[2]), // group 2
                                maxParallelism))
                .isEqualTo(2); // group 2
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[3]), // group 3
                                maxParallelism))
                .isEqualTo(3); // group 3
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[4]), // group 4
                                maxParallelism))
                .isEqualTo(4); // group 4
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[5]), // group 5
                                maxParallelism))
                .isEqualTo(5); // group 5
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[6]), // group 6
                                maxParallelism))
                .isEqualTo(6); // group 6
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[7]), // group 7
                                maxParallelism))
                .isEqualTo(7); // group 7
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[8]), // group 8
                                maxParallelism))
                .isEqualTo(8); // group 8
        ...
        assertThat(
                        KeyGroupRangeAssignment.assignToKeyGroup(
                                keySelector.getKey(records[9]), // group 9
                                maxParallelism))
                .isEqualTo(9); // group 9
    }
