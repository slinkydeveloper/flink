...
public class CEPRescalingTest {
    ...
    public void testCEPFunctionScalingUp() throws Exception {
        ...
        assertThat(keygroup).isEqualTo(1);
        assertThat(
        ...
        try {
            ...
            assertThat(harness1.getOutput().size()).isEqualTo(3);
            ...
            assertThat(harness2.getOutput().size()).isEqualTo(3);
    ...
    public void testCEPFunctionScalingDown() throws Exception {
        ...
        try {
            ...
            assertThat(harness1.getOutput().size()).isEqualTo(1);
            verifyWatermark(harness1.getOutput().poll(), Long.MIN_VALUE);

            assertThat(harness2.getOutput().size()).isEqualTo(1);
            verifyWatermark(harness2.getOutput().poll(), Long.MIN_VALUE);

            assertThat(harness3.getOutput().size()).isEqualTo(1);
            ...
            assertThat(harness4.getOutput().size()).isEqualTo(2);
            ...
            // verify result
            assertThat(harness4.getOutput().size()).isEqualTo(3);
            ...
            assertThat(harness5.getOutput().size()).isEqualTo(2);
