...
public class MockSerializationSchema<T> implements SerializationSchema<T> {
    ...
    public void open(SerializationSchema.InitializationContext context) throws Exception {
        assertThat(openCalled).as("Open was called multiple times").isEqualTo(false);
        assertThat(context.getMetricGroup()).satisfies(matching(notNullValue(MetricGroup.class)));
