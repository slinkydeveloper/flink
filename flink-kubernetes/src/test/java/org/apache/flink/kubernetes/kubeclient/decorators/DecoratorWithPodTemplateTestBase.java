...
public abstract class DecoratorWithPodTemplateTestBase extends KubernetesPodTestBase {
        ...
        assertThat(
                        new ArrayList<>(
                                this.resultPod
                                        ...
                                        .getLabels()
                                        .entrySet()))
                .satisfies(matching(hasItems(expectedLabels.entrySet().toArray())));
    }
    ...
    public void testPodAnnotationsMerging() {
        ...
        assertThat(this.resultPod.getPodWithoutMainContainer().getMetadata().getAnnotations())
                .isEqualTo(equalTo(expectedAnnotations));
    }
    ...
    public void testImagePullSecretsMerging() {
        ...
        assertThat(resultSecrets)
                .satisfies(matching(containsInAnyOrder(expectedPullSecrets.toArray())));
    }
    ...
    public void testNodeSelectorMerging() {
        ...
        assertThat(this.resultPod.getPodWithoutMainContainer().getSpec().getNodeSelector())
                .isEqualTo(equalTo(expectedNodeSelectors));
    }
    ...
    public void testPodTolerationsMerging() {
        ...
        assertThat(this.resultPod.getPodWithoutMainContainer().getSpec().getTolerations())
                .satisfies(matching(Matchers.containsInAnyOrder(expectedTolerations.toArray())));
    }
    ...
    public void testMainContainerEnvMerging() {
        ...
        assertThat(new ArrayList<>(actualEnvs.entrySet()))
                .satisfies(matching(hasItems(expectedEnvs.entrySet().toArray())));
    }
