...
public class KubernetesSessionCliTest {
    ...
    public void testKubernetesSessionCliSetsDeploymentTargetCorrectly() throws CliArgsException {
        ...
        assertThat(configuration.get(DeploymentOptions.TARGET))
                .isEqualTo(KubernetesSessionClusterExecutor.NAME);
    }
    ...
    public void testDynamicProperties() throws Exception {
        ...
        assertThat(executorConfigMap.size()).isEqualTo(4);
        ...
        assertThat(executorConfig.get(DeploymentOptionsInternal.CONF_DIR))
                .isEqualTo(tmp.getRoot().getAbsolutePath());
        assertThat(executorConfigMap.containsKey(DeploymentOptions.TARGET.key())).isTrue();
    }
