...
public class DualInputSemanticPropertiesTest {
    ...
    public void testGetTargetFields() {
        ...
        assertThat(sp.getForwardingTargetFields(1, 4).size()).isEqualTo(0);
        ...
        assertThat(sp.getForwardingTargetFields(1, 0).size()).isEqualTo(2);
        assertThat(sp.getForwardingTargetFields(1, 1).size()).isEqualTo(3);
        ...
        assertThat(sp.getForwardingTargetFields(1, 2).size()).isEqualTo(0);
    ...
    public void testGetReadSet() {
        ...
        assertThat(sp.getReadFields(1).size()).isEqualTo(2);
        ...
        assertThat(sp.getReadFields(1).size()).isEqualTo(3);
        assertThat(sp.getReadFields(1).contains(0)).isTrue();
        assertThat(sp.getReadFields(1).contains(1)).isTrue();
